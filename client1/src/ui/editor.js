...
//                    if (RED.view.state() === RED.state.EDITING_LINK) {
//                        RED.taskgraph.showLinkPartitions(editing_node.partitionName);
//                        RED.taskgraph.showConstraints(editing_node.constraintName);
//                    } else {
//                        RED.taskgraph.showNodePartitions(editing_node.partitionName);
//                        RED.taskgraph.showTaskGroups(editing_node.group);
//                    }
                }
            },
            close: function(e) {
...
//                RED.sidebar.config.refresh();
  ...
  /*
    $('#import-background-dialog-form').fileUpload({
        success: function (data,textStatus,jqXHR) {
            RED.view.showImportedBackground(data);
        },
