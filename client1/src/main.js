...
var RED = function() {
    ...
    var DEVICE_NODES = [
        ...
        "WaterSensor",
        "WristbandSensor",
        //"CurrentCostSensor", // disabled for not to simplify the game
    ];
    ...
    return {
        ...
        importOptions: function(globalOptions) {
            ...
            // if server is readonly, default to local storage
            // if (RED.settings.serverReadOnly) options.flowsOnServer = false;
        },
